...
def order_details():
    if request.method == 'POST':
        ...
        return render_template('/InventoryManager/order_details.html', order_status=order_status,
...
def return_token():
    if request.method == 'POST':
        ...
        if retval == 0:
            ...
            return render_template('/TokenManager/failure_returned.html',
                                   reason="Token has products. Remove them first to continue.")
        elif retval == 2:
            return render_template('/TokenManager/failure_returned.html',
                                   reason="Token is not assigned. Please check again and continue")
        elif retval == 3:
            return render_template('/TokenManager/failure_returned.html',
                                   reason="Token not found. Please confirm token ID and continue")
    else:
...
def remove_token():
    if request.method == 'POST':
        ...
        if retval == 0:
            ...
            return render_template('/TokenManager/failure_remove_token.html',
                                   reason="Token already has products. Please remove them before proceeding.")
        elif retval == 2:
            return render_template('/TokenManager/failure_remove_token.html',
                                   reason="Token is already assigned. Please desassign it to continue.")
        elif retval == 3:
            return render_template('/TokenManager/failure_remove_token.html',
                                   reason="Token not found. Please check Token ID and continue")
    else:
        return render_template('/TokenManager/token_home.html')
...
def add_products_to_token():
    if request.method == 'POST':
        ...
        if retval == 0:
            ...
            return render_template('/CounterOperator/failure_product_to_token.html',
                                   reason="Token not found or is not assigned")
        elif retval == 2:
            ...
            return render_template('/CounterOperator/failure_product_to_token.html',
                                   reason="Quantity not sufficient in inventory")
    else:
...
def add_inventory_to_counter():
    if request.method == 'POST':
        ...
        if retval == 0:
            ...
            return render_template('/CounterOperator/failure_inventory_to_counter.html',
                                   reason="Product not found in inventory")
        elif retval == 3:
            return render_template('/CounterOperator/failure_inventory_to_counter.html',
                                   reason="Quantity in warehouse not sufficient")
    else:
...
def add_token_to_counter():
    if request.method == 'POST':
        ...
        if retval == 0:
            ...
            return render_template('/CounterManager/failure_token_to_counter.html',
                                   reason="Product not present in selected Token")
    else:
